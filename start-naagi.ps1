...
$services = @(
    @{ Name = "naagi-rag-service";      Port = 8080; Dir = "naagi-rag-service" },
    @{ Name = "naagi-tool-registry";    Port = 8081; Dir = "naagi-tool-registry" },
    @{ Name = "naagi-mcp-gateway";      Port = 8082; Dir = "naagi-mcp-gateway" },
    @{ Name = "naagi-utility-tools";    Port = 8083; Dir = "naagi-utility-tools" },
    @{ Name = "naagi-category-admin";   Port = 8085; Dir = "naagi-category-admin" },
    @{ Name = "naagi-ai-orchestrator";  Port = 8086; Dir = "naagi-ai-orchestrator" },
    @{ Name = "naagi-chat-app";         Port = 8087; Dir = "naagi-chat-app" }
)

$basePath = "d:\apps\ws\ws8"
$logDir = "$basePath\logs"
$pidFile = "$basePath\.naagi-pids.json"
...
Write-Host "  .\start-naag.ps1 -Service naagi-chat-app  # Start single service"
Write-Host ""

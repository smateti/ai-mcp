...
|---------|------|----------|
| naag-rag-service | 8080 | RAG operations |
| naag-tool-registry | 8081 | Tool metadata |
| naag-mcp-gateway | 8082 | MCP protocol |
| naag-utility-tools | 8083 | Built-in tools |
| naag-category-admin | 8085 | Admin UI |
| naag-ai-orchestrator | 8086 | LLM routing |
| naag-chat-app | 8087 | Chat UI |

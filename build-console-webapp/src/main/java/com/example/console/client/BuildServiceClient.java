...
public class BuildServiceClient {
     ...
     * POST /api/builds
     */
    public JsonObject triggerBuild(String appName, String environment, String gitlabInstance) {
        var builder = Json.createObjectBuilder()
                .add("appName", appName)
                .add("environment", environment);
        if (gitlabInstance != null && !gitlabInstance.isBlank()) {
            builder.add("gitlabInstance", gitlabInstance);
        }

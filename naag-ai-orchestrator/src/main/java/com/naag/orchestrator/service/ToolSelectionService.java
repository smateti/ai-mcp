...
import com.naag.orchestrator.model.AlternativeTool;
import com.naag.orchestrator.model.ToolSelectionResult;
...
public class ToolSelectionService {
    ...
    @Value("${naag.tool-selection.confidence.high-threshold:0.8}")
    private double highConfidenceThreshold;

    @Value("${naag.tool-selection.confidence.low-threshold:0.5}")

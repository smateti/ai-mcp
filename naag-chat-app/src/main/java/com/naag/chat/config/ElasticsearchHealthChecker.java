...
import com.naag.chat.repository.AuditLogElasticsearchRepository;
...
@Slf4j
@EnableScheduling
@ConditionalOnExpression("'${naag.persistence.audit.type:H2}' == 'ELASTICSEARCH' or '${naag.persistence.audit.type:H2}' == 'BOTH'")
public class ElasticsearchHealthChecker {

    @Value("${spring.elasticsearch.uris:http://localhost:9200}")
    private String elasticsearchUri;

    @Value("${naag.elasticsearch.health-check-interval-seconds:60}")
     ...
     */
    @Scheduled(fixedDelayString = "${naag.elasticsearch.health-check-interval-seconds:60}000")

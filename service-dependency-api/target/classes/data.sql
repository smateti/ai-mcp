...
-- Insert 50 Applications with app_type (BATCH, MICROSERVICE, UI)
INSERT INTO applications (id, application_id, name, description, owner, status, app_type) VALUES
(1, 'APP-USER-MGMT', 'User Management System', 'Handles user authentication and profiles', 'Team Alpha', 'ACTIVE', 'MICROSERVICE'),
(2, 'APP-ORDER-PROC', 'Order Processing System', 'Processes customer orders', 'Team Beta', 'ACTIVE', 'MICROSERVICE'),
(3, 'APP-PAYMENT-GW', 'Payment Gateway', 'Handles payment transactions', 'Team Gamma', 'ACTIVE', 'MICROSERVICE'),
(4, 'APP-INVENTORY', 'Inventory Management', 'Manages product inventory', 'Team Delta', 'ACTIVE', 'MICROSERVICE'),
(5, 'APP-SHIPPING', 'Shipping Service', 'Coordinates product shipping', 'Team Epsilon', 'ACTIVE', 'MICROSERVICE'),
(6, 'APP-NOTIFICATION', 'Notification System', 'Sends emails and SMS', 'Team Zeta', 'ACTIVE', 'MICROSERVICE'),
(7, 'APP-ANALYTICS', 'Analytics Engine', 'Business intelligence and reports', 'Team Eta', 'ACTIVE', 'BATCH'),
(8, 'APP-SEARCH', 'Search Service', 'Product and content search', 'Team Theta', 'ACTIVE', 'MICROSERVICE'),
(9, 'APP-RECOMMEND', 'Recommendation Engine', 'Product recommendations', 'Team Iota', 'ACTIVE', 'BATCH'),
(10, 'APP-PRICING', 'Pricing Service', 'Dynamic pricing calculations', 'Team Kappa', 'ACTIVE', 'MICROSERVICE'),
(11, 'APP-TAX-CALC', 'Tax Calculator', 'Calculates taxes for orders', 'Team Lambda', 'ACTIVE', 'MICROSERVICE'),
(12, 'APP-DISCOUNT', 'Discount Engine', 'Manages promotions and discounts', 'Team Mu', 'ACTIVE', 'MICROSERVICE'),
(13, 'APP-REVIEW', 'Review System', 'Customer reviews and ratings', 'Team Nu', 'ACTIVE', 'MICROSERVICE'),
(14, 'APP-WISHLIST', 'Wishlist Service', 'User wishlists and favorites', 'Team Xi', 'ACTIVE', 'MICROSERVICE'),
(15, 'APP-CART', 'Shopping Cart', 'Shopping cart management', 'Team Omicron', 'ACTIVE', 'MICROSERVICE'),
(16, 'APP-CATALOG', 'Product Catalog', 'Product information management', 'Team Pi', 'ACTIVE', 'MICROSERVICE'),
(17, 'APP-MEDIA', 'Media Service', 'Image and video management', 'Team Rho', 'ACTIVE', 'MICROSERVICE'),
(18, 'APP-FULFILLMENT', 'Order Fulfillment', 'Warehouse and fulfillment', 'Team Sigma', 'ACTIVE', 'BATCH'),
(19, 'APP-RETURNS', 'Returns Management', 'Handles product returns', 'Team Tau', 'ACTIVE', 'MICROSERVICE'),
(20, 'APP-LOYALTY', 'Loyalty Program', 'Customer loyalty and rewards', 'Team Upsilon', 'ACTIVE', 'MICROSERVICE'),
(21, 'APP-CMS', 'Content Management', 'Website content management', 'Team Phi', 'ACTIVE', 'UI'),
(22, 'APP-SUPPORT', 'Customer Support', 'Support tickets and chat', 'Team Chi', 'ACTIVE', 'UI'),
(23, 'APP-FRAUD', 'Fraud Detection', 'Fraud prevention system', 'Team Psi', 'ACTIVE', 'BATCH'),
(24, 'APP-VENDOR', 'Vendor Management', 'Third-party vendor coordination', 'Team Omega', 'ACTIVE', 'UI'),
(25, 'APP-SUBSCRIPTION', 'Subscription Service', 'Recurring subscriptions', 'Team Alpha2', 'ACTIVE', 'MICROSERVICE'),
(26, 'APP-BILLING', 'Billing System', 'Invoice and billing', 'Team Beta2', 'ACTIVE', 'BATCH'),
(27, 'APP-REPORTING', 'Reporting Service', 'Business reports', 'Team Gamma2', 'ACTIVE', 'BATCH'),
(28, 'APP-AUDIT', 'Audit Logger', 'System audit logs', 'Team Delta2', 'ACTIVE', 'BATCH'),
(29, 'APP-CONFIG', 'Configuration Service', 'Application configuration', 'Team Epsilon2', 'ACTIVE', 'MICROSERVICE'),
(30, 'APP-CACHE', 'Caching Service', 'Distributed caching', 'Team Zeta2', 'ACTIVE', 'MICROSERVICE'),
(31, 'APP-SESSION', 'Session Management', 'User session handling', 'Team Eta2', 'ACTIVE', 'MICROSERVICE'),
(32, 'APP-LOCALE', 'Localization Service', 'Multi-language support', 'Team Theta2', 'ACTIVE', 'MICROSERVICE'),
(33, 'APP-CURRENCY', 'Currency Converter', 'Multi-currency support', 'Team Iota2', 'ACTIVE', 'MICROSERVICE'),
(34, 'APP-GEO', 'Geolocation Service', 'Location-based services', 'Team Kappa2', 'ACTIVE', 'MICROSERVICE'),
(35, 'APP-WEATHER', 'Weather Service', 'Weather information', 'Team Lambda2', 'ACTIVE', 'MICROSERVICE'),
(36, 'APP-ADDRESS', 'Address Validation', 'Address verification', 'Team Mu2', 'ACTIVE', 'MICROSERVICE'),
(37, 'APP-CREDIT', 'Credit Check', 'Credit verification', 'Team Nu2', 'ACTIVE', 'MICROSERVICE'),
(38, 'APP-KYC', 'KYC Verification', 'Know Your Customer checks', 'Team Xi2', 'ACTIVE', 'MICROSERVICE'),
(39, 'APP-COMPLIANCE', 'Compliance Service', 'Regulatory compliance', 'Team Omicron2', 'ACTIVE', 'BATCH'),
(40, 'APP-EMAIL', 'Email Service', 'Email delivery', 'Team Pi2', 'ACTIVE', 'MICROSERVICE'),
(41, 'APP-SMS', 'SMS Service', 'SMS notifications', 'Team Rho2', 'ACTIVE', 'MICROSERVICE'),
(42, 'APP-PUSH', 'Push Notification', 'Mobile push notifications', 'Team Sigma2', 'ACTIVE', 'MICROSERVICE'),
(43, 'APP-QUEUE', 'Message Queue', 'Asynchronous messaging', 'Team Tau2', 'ACTIVE', 'MICROSERVICE'),
(44, 'APP-SCHEDULER', 'Job Scheduler', 'Background job scheduling', 'Team Upsilon2', 'ACTIVE', 'BATCH'),
(45, 'APP-FILE', 'File Storage', 'Document storage', 'Team Phi2', 'ACTIVE', 'MICROSERVICE'),
(46, 'APP-BACKUP', 'Backup Service', 'Data backup', 'Team Chi2', 'ACTIVE', 'BATCH'),
(47, 'APP-MONITOR', 'Monitoring Service', 'System monitoring', 'Team Psi2', 'ACTIVE', 'UI'),
(48, 'APP-HEALTH', 'Health Check', 'Service health monitoring', 'Team Omega2', 'ACTIVE', 'MICROSERVICE'),
(49, 'APP-GATEWAY', 'API Gateway', 'API routing and management', 'Team Alpha3', 'ACTIVE', 'MICROSERVICE'),
(50, 'APP-AUTH', 'Authorization Service', 'Permission and roles', 'Team Beta3', 'ACTIVE', 'MICROSERVICE');

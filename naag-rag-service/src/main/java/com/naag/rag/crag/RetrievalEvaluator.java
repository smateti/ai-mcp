...
public class RetrievalEvaluator {
    ...
    public RetrievalEvaluator(
            ...
            @Value("${naag.rag.crag.llm-evaluation-enabled:false}") boolean llmEvaluationEnabled,
            @Value("${naag.rag.crag.high-confidence-threshold:0.8}") double highConfidenceThreshold,
            @Value("${naag.rag.crag.low-confidence-threshold:0.5}") double lowConfidenceThreshold,
            @Value("${naag.rag.crag.score-gap-threshold:0.15}") double scoreGapThreshold
    ) {

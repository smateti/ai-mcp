...
import com.naag.rag.search.BM25Index.BM25Result;
    ...
    class RRFFusionTests {
        ...
        void testBasicRRFFusion() {
            ...
            List<SearchHit> denseResults = List.of(
                    new SearchHit("id1", "doc1", 0, "text1", 0.95),
                    new SearchHit("id2", "doc1", 1, "text2", 0.85),
                    new SearchHit("id3", "doc2", 0, "text3", 0.75)
            );

            // Sparse results (BM25) - note id2 appears in both
            List<SearchHit> sparseResults = List.of(
                    new SearchHit("id2", "doc1", 1, "text2", 5.5),  // Also in dense
                    new SearchHit("id4", "doc3", 0, "text4", 4.2),
                    new SearchHit("id1", "doc1", 0, "text1", 3.8)   // Also in dense
            );
        ...
        void testWeightedRRFFusion() {
            ...
            List<SearchHit> sparseResults = List.of(
                    new SearchHit("id2", "doc2", 0, "text2", 5.5)
            );
        ...
        void testEmptyResults() {
            ...
            List<SearchHit> denseOnly = List.of(
                    new SearchHit("id1", "doc1", 0, "text1", 0.9)
            );
            ...
            List<SearchHit> sparseOnly = List.of(
                    new SearchHit("id2", "doc2", 0, "text2", 5.0)
            );
        ...
        void testLinearCombination() {
            List<SearchHit> denseResults = List.of(
                    new SearchHit("id1", "doc1", 0, "text1", 0.9),
                    new SearchHit("id2", "doc1", 1, "text2", 0.5)
            );

            List<SearchHit> sparseResults = List.of(
                    new SearchHit("id2", "doc1", 1, "text2", 10.0),
                    new SearchHit("id3", "doc2", 0, "text3", 5.0)
            );
        ...
        void testTopKLimit() {
            List<SearchHit> denseResults = List.of(
                    new SearchHit("id1", "doc1", 0, "text1", 0.9),
                    new SearchHit("id2", "doc1", 1, "text2", 0.8),
                    new SearchHit("id3", "doc1", 2, "text3", 0.7),
                    new SearchHit("id4", "doc1", 3, "text4", 0.6),
                    new SearchHit("id5", "doc1", 4, "text5", 0.5)
            );

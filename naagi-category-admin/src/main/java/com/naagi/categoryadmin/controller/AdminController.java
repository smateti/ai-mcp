...
import com.naagi.categoryadmin.service.AuditLogService;
...
import com.naagi.categoryadmin.service.DocumentParserService;
import com.naagi.categoryadmin.service.SetupDataInitializer;
...
public class AdminController {
    ...
    public String saveToolOverride(@PathVariable String categoryId,
                                   ...
                                   RedirectAttributes redirectAttributes) {
        try {
            com.naagi.categoryadmin.model.CategoryToolOverride override =
                    com.naagi.categoryadmin.model.CategoryToolOverride.builder()
                            .categoryId(categoryId)
                            .toolId(toolId)
                            .whenToUse(whenToUse)
     ...
     */
    @PatchMapping("/documents/uploads/{uploadId}/title")
    @ResponseBody
    public Map<String, Object> updateUploadTitle(
            @PathVariable String uploadId,
            @RequestBody Map<String, String> request) {
        try {
            ...
            var result = ragServiceClient.updateUploadTitle(uploadId, title);
            ...
            auditLogService.log("admin", "DOCUMENT_TITLE_UPDATE", "document", docId,
                    "Title updated to: " + title, categoryId, AuditLog.AuditStatus.SUCCESS, null);
     ...
     */
    @PatchMapping("/documents/{docId}/title")
    @ResponseBody
    public Map<String, Object> updateDocumentTitle(
        ...
        try {
            ...
            // Get categoryId for audit logging
            String categoryId = null;
            var details = ragServiceClient.getUploadDetails(uploadId);
            if (details != null && details.has("upload")) {
                var upload = details.get("upload");

...
/**
 * Shared container configuration for MicroShed integration tests.
 * Starts DB2 + Liberty app (Conjur is skipped in test mode —
 * DB credentials are passed directly as environment variables).
 */
public class AppContainerConfig implements SharedContainerConfiguration {
    ...
    public static ApplicationContainer app = new ApplicationContainer()
            ...
            // Skip Conjur in test mode — ConfigSource will fall back to defaults
